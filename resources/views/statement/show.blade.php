<div class="modal fade bs-example-modal-sm" id="verDeclaracion-{{$statement->id}}" tabindex="-1" aria-labelledby="verDeclaracionModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            <div class="modal-header bg-light p-3">
                <h5 class="modal-title" id="verDeclaracionModalLabel">Actualizar declaración</h5>
                        ...
                        <div class="row">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" id="date" name="date" class="form-control" value="{{ $statement->date }}" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    <input value="{{ $statement->sales }}" placeholder="0" type="number" id="sales" name="sales" class="form-control" readonly/>
                                </div>

                                <div class="col-md-3">
                                    <label for="discounts" class="form-label">Descuentos</label>
                                    <input value="{{ $statement->discounts }}" placeholder="0" type="number" id="discounts" name="discounts" class="form-control" readonly/>
                                </div>

                                <div class="col-md-3">
                                    <label for="purchases" class="form-label">Compras</label>
                                    <input value="{{ $statement->purchases }}" placeholder="0" type="number" id="purchases" name="purchases" class="form-control" readonly/>
                                </div>

                                <div class="col-md-3">
                                    <label for="recorded_purchases" class="form-label">Compras Grabadas</label>
                                    <input value="{{ $statement->recorded_purchases }}" placeholder="0" type="number" id="recorded_purchases" name="recorded_purchases" class="form-control" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    <input value="{{ $statement->previous_balance }}" placeholder="0" type="number" id="previous_balance" name="previous_balance" class="form-control" readonly/>
                                </div>

                                <div class="col-md-3">
                                    <label for="update" class="form-label">Actualización</label>
                                    <input value="{{ $statement->update }}" placeholder="0" type="number" id="update" name="update" class="form-control" readonly/>
                                </div>

                                <div class="col-md-3">
                                    <label for="current_balance" class="form-label">Saldo Actual</label>
                                    <input value="{{ $statement->current_balance }}" placeholder="0" type="number" id="current_balance" name="current_balance" class="form-control" readonly/>
                                </div>

                                <div class="col-md-3">
                                    <label for="calculated_IVA" class="form-label">IVA calculado</label>
                                    <input value="{{ $statement->calculated_IVA }}" placeholder="0" type="number" id="calculated_IVA" name="calculated_IVA" class="form-control" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    <input value="{{ $statement->real_IVA }}" placeholder="0" type="number" id="real_IVA" name="real_IVA" class="form-control" readonly/>
                                </div>

                                <div class="col-md-2">
                                    <label for="comp_IUE" class="form-label">Comp del IUE</label>
                                    <input value="{{ $statement->comp_IUE }}" placeholder="0" type="number" id="comp_IUE" name="comp_IUE" class="form-control" readonly/>
                                </div>

                                <div class="col-md-2">
                                    <label for="calculated_IT" class="form-label">IT Calculado</label>
                                    <input value="{{ $statement->calculated_IT }}" placeholder="0" type="number" id="calculated_IT" name="calculated_IT" class="form-control" readonly/>
                                </div>

                                <div class="col-md-2">
                                    <label for="real_IT" class="form-label">IT Real</label>
                                    <input value="{{ $statement->real_IT }}" placeholder="0" type="number" id="real_IT" name="real_IT" class="form-control" readonly/>
                                </div>

                                <div class="col-md-3">
                                    <label for="IUE" class="form-label">IUE</label>
                                    <input value="{{ $statement->IUE }}" placeholder="0" type="number" id="IUE" name="IUE" class="form-control" readonly/>
                                </div>
                            </div>
